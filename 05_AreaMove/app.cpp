...
debrisys::SubRun* gRightRotate[2] = {nullptr};  // 右旋回走行
...
static void create_system()
{
    ...
    gEncoderTurn[2] = new debrisys::EncoderPDControl(gLeftCount, gRightCount);
    gEncoderTurn[3] = new debrisys::EncoderPDControl(gLeftCount, gRightCount);
    gRightRotate[0] = new debrisys::RotateRun(gLeftMotor, gRightMotor, gGyroTurn[0], gEncoderTurn[0], debrisys::ERotDire::RIGHT);
    gRightRotate[1] = new debrisys::RotateRun(gLeftMotor, gRightMotor, gGyroTurn[1], gEncoderTurn[1], debrisys::ERotDire::RIGHT);
    ...
    gStep[0]        = new debrisys::Step(gRightRotate[0], gRightJudge[0], gInit[0]);
    gStep[1]        = new debrisys::Step(gFrontStra[0], gFrontJudge[0], gInit[1]);
    gStep[2]        = new debrisys::Step(gRightRotate[1], gRightJudge[1], gInit[2]);
...
static void destroy_system()
{
    ...
    delete   gRightRotate[0]; 
    delete   gRightRotate[1]; 
    delete   gFrontStra[0]; 
    delete   gFrontStra[1]; 
    ...
    gRightRotate[0] = nullptr;
    gRightRotate[1] = nullptr;
