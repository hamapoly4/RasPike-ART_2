...
static void create_system()
{
    ...
    gRotateJudge[2] = new debrisys::RotateAngleJudge(gJudgeAng[2], TARGET_ANGL[2]);
    gRotateJudge[3] = new debrisys::RotateAngleJudge(gJudgeAng[3], TARGET_ANGL[1]);
    ...
    gRotateJudge[6] = new debrisys::RotateAngleJudge(gJudgeAng[6], TARGET_ANGL[2]);
    gRotateJudge[7] = new debrisys::RotateAngleJudge(gJudgeAng[7], TARGET_ANGL[1]);
    ...
    gCircle = new debrisys::Circle[4] {
        debrisys::Circle(gCir1Step, gBlueDetect, true),
        debrisys::Circle(gCir2Step, gBlueDetect, true),
        debrisys::Circle(gCir3Step, gBlueDetect, true),
        debrisys::Circle(gCir4Step, gBlueDetect, true)
    };
