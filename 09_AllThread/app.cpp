...
static const float TARGET_ANGL[] = { 0, 42, 135, };
...
static void create_system()
{
    ...
    gCircle = new debrisys::Circle[4] {
        ...
        debrisys::Circle(gCir2Step, gBlueDetect, false),
        debrisys::Circle(gCir3Step, gBlueDetect, false),
